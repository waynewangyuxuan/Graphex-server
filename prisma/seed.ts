 ...
 */
function generateMermaidCode(nodeCount: number): string {
 ...
 */
function generateQuizOptions(correctAnswer: string): Array<{ id: number; text: string }> {
  return [
...
async function seedGraphs(documents: any[]) {
...
async function seedNodes(graphs: any[]) {
...
async function seedEdges(graphs: any[]) {
...
async function seedNotes(graphs: any[]) {
...
async function seedQuizQuestions(graphs: any[]) {
